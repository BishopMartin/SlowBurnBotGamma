          ...
          <table className="w-full">
            <thead>
              <tr className="text-left text-base04 border-b border-base03 bg-base01">
                ...
                <th className="px-[10px] py-2 font-normal">Status</th>
                <th className="px-[10px] py-2 font-normal">State</th>
                <th className="px-[10px] py-2 font-normal whitespace-nowrap">Current Action</th>
                <th className="px-[10px] py-2 font-normal whitespace-nowrap">Last Session</th>
                  ...
                  <tr key={account.id} className={`hover:bg-base02 transition-colors ${account.system_disabled ? "text-fg-disabled" : account.enabled ? "text-base05" : "text-base04"}`}>
                    ...
                    {tab === "stats" && (
                      <>
                        ...
                        <td className="px-[10px] py-2 whitespace-nowrap">{fb ? (fb.followed / (fb.days || 1)).toFixed(1) : "----"}</td>
                      </>
                    )}
                    {tab === "database" && (
                      <>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-base04 border-b border-base03 bg-base01">
                  ...
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">start</th>
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">end</th>
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">action 1</th>
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">action 2</th>
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">action 3</th>
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">action 4</th>
                  <th className="px-[10px] py-2 font-normal whitespace-nowrap">errors</th>
                </tr>
              </thead>
              <tbody>
                {(() => {
