...
def do_random_action(driver, account):
    """
    ...
    try:
        ...
        try:
            print(f"- [{account}]: [random] - warning: dispatcher failed")
        except Exception:
            pass
...
def do_random_explore(driver, account, posts_to_click: int | None = None):
    ...
    try:
        ...
        try:
            print(f"- [{account}]: [random][explore] - warning: action failed")
        except Exception:
            pass
...
def do_random_actions(driver, account, reels_to_watch: int = 2):
    ...
    try:
        ...
        try:
            print(f"- [{account}]: [random][reels] - warning: action failed")
        except Exception:
            pass
